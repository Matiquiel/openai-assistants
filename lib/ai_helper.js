...
class AIHelper {
     ...
     */
    CreateAssistant(name, description, instructions, withCodeInterpreter, withFilesReader, codeInterpreterFiles = [], filesReaderFiles = []) {
        return __awaiter(this, void 0, void 0, function* () {
 ...
 */
    ...
    CreateThread(userMessage = undefined) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
    ...
    */
    CreateRun(threadId, assistantId, extraInstructions = undefined, additionalMessages = undefined, withFileSearch = false, withCodeInterpreter = false) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                var options = {
